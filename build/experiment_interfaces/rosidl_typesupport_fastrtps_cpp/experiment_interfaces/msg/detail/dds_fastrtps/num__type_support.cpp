...
#include "experiment_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const experiment_interfaces::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  experiment_interfaces::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = experiment_interfaces::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const experiment_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<experiment_interfaces::msg::Num *>(
    untyped_ros_message);
...
get_message_type_support_handle<experiment_interfaces::msg::Num>()
{
  return &experiment_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, experiment_interfaces, msg, Num)() {
  return &experiment_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
