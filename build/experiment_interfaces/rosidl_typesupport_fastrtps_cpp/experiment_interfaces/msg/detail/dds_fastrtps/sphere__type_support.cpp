...
#include "experiment_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const experiment_interfaces::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  experiment_interfaces::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = experiment_interfaces::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const experiment_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<experiment_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_experiment_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<experiment_interfaces::msg::Sphere>()
{
  return &experiment_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, experiment_interfaces, msg, Sphere)() {
  return &experiment_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
