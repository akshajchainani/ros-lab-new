...
bool dob_interfaces__msg__dob__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dob_interfaces.msg._dob.Dob", full_classname_dest, 27) == 0);
  }
  dob_interfaces__msg__Dob * ros_message = _ros_message;
  {  // year
...
{
  /* NOTE(esteve): Call constructor of Dob */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dob_interfaces.msg._dob");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Dob");
